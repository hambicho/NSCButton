...
Pod::Spec.new do |s|
  s.name             = "NSCButton"
  s.version          = "0.1.0"
  s.summary          = "A short description of NSCButton."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/NSCButton"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Henry AT" => "henry.ambicho@mercadolibre.cl" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/NSCButton.git", :tag => s.version.to_s }
